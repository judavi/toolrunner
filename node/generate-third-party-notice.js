...
function* thirdPartyNotice(libName, licenseInfo) {
    ...
    yield '';
    yield `This NPM Library (${libName}) is based on or incorporates material from the projects listed below (Third Party IP). The original copyright notice and the license under which this library received such Third Party IP, are set forth below. Such licenses and notices are provided for informational purposes only.`;
    yield '';
